...
docker-build:
	docker compose --env-file ./.env -f deploy/docker-compose.prod.yml build $(args)

docker-dev:
	docker compose --env-file ./.env.dev -f deploy/docker-compose.dev.yml up -d --remove-orphans

docker-run:
	docker compose --env-file ./.env.prod -f deploy/docker-compose.prod.yml up -d --remove-orphans
